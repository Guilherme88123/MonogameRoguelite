...
public abstract class BaseCreatureModel : BaseEntityModel
{
    ...
    public override void Update(GameTime gameTime, List<BaseEntityModel> entities)
    {
        ...
        posX = MathHelper.Clamp(Position.X, 0, GlobalVariables.Graphics.PreferredBackBufferWidth - Size);
        posY = MathHelper.Clamp(Position.Y, 0, GlobalVariables.Graphics.PreferredBackBufferHeight - Size);
